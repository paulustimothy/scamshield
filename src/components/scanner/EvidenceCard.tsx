  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="shrink-0 w-7 h-7 rounded-full bg-white/[0.06] hover:bg-red-500/20 text-muted-foreground hover:text-red-400 flex items-center justify-center transition-all active:scale-90"
