...
export function getFallbackImageResult(): ScamAnalysisResult {
  return {
    ...
    suspiciousPhrases: [],
    scamTypes: ['Analisis Gambar'],
    explanation: 'Sistem AI sedang dalam mode terbatas. Gambar ini perlu dianalisis ulang saat sistem kembali normal untuk hasil yang lebih akurat.',
    simpleExplanation: 'Maaf, sistem sedang sibuk. Coba lagi nanti untuk analisis yang lebih lengkap.',
    recommendedActions: [
      'Coba analisis ulang beberapa saat lagi',
      'Jangan langsung percaya konten dalam gambar',
      'Verifikasi informasi melalui saluran resmi',
    ],
    redFlags: ['Analisis dalam mode terbatas — coba lagi nanti untuk hasil lengkap'],
    safeIndicators: [],
...
export function getFallbackAudioResult(): ScamAnalysisResult & { transcript: string } {
  return {
    ...
    suspiciousPhrases: [],
    scamTypes: ['Analisis Audio'],
    explanation: 'Sistem AI sedang dalam mode terbatas. Audio ini perlu dianalisis ulang saat sistem kembali normal untuk hasil yang lebih akurat.',
    simpleExplanation: 'Maaf, sistem sedang sibuk. Coba lagi nanti untuk analisis yang lebih lengkap.',
    recommendedActions: [
      'Coba analisis ulang beberapa saat lagi',
      'Jangan langsung percaya konten dalam rekaman',
      'Verifikasi informasi melalui saluran resmi',
    ],
    redFlags: ['Analisis dalam mode terbatas — coba lagi nanti untuk hasil lengkap'],
    safeIndicators: [],
