...
const features = [
  { icon: Search, title: 'Analisis Teks AI', desc: 'Paste chat WhatsApp, SMS, atau email mencurigakan untuk dianalisis AI secara real-time.', color: 'from-blue-500/20 to-cyan-500/20 border-blue-500/20' },
  { icon: Camera, title: 'Baca Screenshot', desc: 'Upload tangkapan layar dan AI akan membaca serta menganalisis isinya secara otomatis.', color: 'from-purple-500/20 to-indigo-500/20 border-purple-500/20' },
  { icon: Globe, title: 'Analisis URL & Link', desc: 'Periksa link mencurigakan dengan deteksi typosquatting, reputasi domain, dan VirusTotal.', color: 'from-orange-500/20 to-amber-500/20 border-orange-500/20' },
  { icon: MessageCircle, title: 'Chat AI Assistant', desc: 'Tanya apa saja tentang keamanan online — AI menjawab dalam Bahasa Indonesia.', color: 'from-violet-500/20 to-purple-500/20 border-violet-500/20' },
];
...
export default function LandingPage() {
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-strong border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white font-bold text-sm sm:text-base shadow-lg shadow-blue-500/20">
              S
            </div>
            <span className="font-semibold text-base sm:text-lg tracking-tight">ScamShield</span>
          </div>
          <Link href="/scanner">
            <Button size="sm" className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white border-0 shadow-lg shadow-blue-500/25 text-xs sm:text-sm">
              Mulai Scan
            </Button>
          </Link>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Link href="/scanner" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white border-0 text-sm sm:text-base px-6 sm:px-8 shadow-xl shadow-blue-500/25 active:scale-[0.98]">
                🔍 Coba Scan Sekarang
              </Button>
            </Link>
      ...
      {/* Interactive Demo — labeled transparently */}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-2 sm:mb-3">
              🛡️ Contoh Analisis ScamShield
            </h2>
            <p className="text-center text-muted-foreground text-sm sm:text-base mb-6 sm:mb-8">
              Lihat bagaimana ScamShield AI menganalisis pesan penipuan umum di Indonesia
            </p>
            <InteractiveDemo />
          </motion.div>
        </div>
            ...
            {features.map((feature, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group p-4 sm:p-5 rounded-2xl bg-card border border-border hover:bg-muted/30 hover:border-primary/20 transition-all duration-300"
                >
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6">
        ...
        >
          <div className="p-6 sm:p-8 md:p-12 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-blue-500/10 via-cyan-500/5 to-transparent border border-blue-500/20">
            ...
            <Link href="/scanner">
              <Button size="lg" className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white border-0 text-sm sm:text-base px-6 sm:px-8 shadow-xl shadow-blue-500/25 active:scale-[0.98]">
      ...
      <footer className="py-6 sm:py-8 px-4 sm:px-6 border-t border-border">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-xs text-muted-foreground">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 rounded bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-white text-[10px] font-bold">S</div>
            <span>ScamShield © 2025 — Powered by Google Gemini AI</span>
          </div>
